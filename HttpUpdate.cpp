...
#if HTTPUPDATE_1_2_COMPATIBLE
HTTPUpdateResult HTTPUpdate::updateSpiffs(const String& url, const String& currentVersion, const String& httpsFingerprint)
{
    HTTPClient http;
#pragma GCC diagnostic push
#pragma GCC diagnostic ignored  "-Wdeprecated-declarations"
...
HTTPUpdateResult HTTPUpdate::updateSpiffs(const String& url, const String& currentVersion, const uint8_t httpsFingerprint[20])
{
    HTTPClient http;
#pragma GCC diagnostic push
#pragma GCC diagnostic ignored  "-Wdeprecated-declarations"
...
HTTPUpdateResult HTTPUpdate::updateSpiffs(const String& url, const String& currentVersion)
{
    HTTPClient http;
#pragma GCC diagnostic push
#pragma GCC diagnostic ignored  "-Wdeprecated-declarations"
...
HTTPUpdateResult HTTPUpdate::update(const String& host, uint16_t port, const String& url,
    ...
    case HTTP_CODE_OK:  ///< OK (Start Update)
        if(len > 0) {
            ...
            if (!startUpdate) {
                ...
                if (!_installUpdate){
                    ret = HTTP_UPDATE_AVAILABLE;
                    DEBUG_HTTP_UPDATE("[httpUpdate] Update available\n");
                }
                else{
